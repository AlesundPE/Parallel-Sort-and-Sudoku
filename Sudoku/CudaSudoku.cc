...
int main(int argc, char* argv[]) {
    ...
    const unsigned int maxBlocks = 32;
    // filename of the starting board
    char* filename = "C:\\Users\\90381\\source\\repos\\sudoku\\sudoku\\hard_1.txt";
    ...
    clock_t end = clock();
    double gpu_elapsed_time_s = (double)(end - begin) / CLOCKS_PER_SEC;

    // compute time elapse on GPU computing
    
    printf("Time elapsed on Sudoku on GPU: %f s.\n\n", gpu_elapsed_time_s);
